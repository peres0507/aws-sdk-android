...
import com.amazonaws.services.amazonfsx.model.FileSystemNotFoundException;
...
public class FileSystemNotFoundExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("FileSystemNotFound");
    }

    @Override
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {

        FileSystemNotFoundException e = (FileSystemNotFoundException) super.unmarshall(error);
