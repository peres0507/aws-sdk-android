...
public enum DataRepositoryTaskLifecycle {
    ...
    private static final Map<String, DataRepositoryTaskLifecycle> enumMap;
    static {
        enumMap = new HashMap<String, DataRepositoryTaskLifecycle>();
        ...
        enumMap.put("CANCELING", CANCELING);
    }
