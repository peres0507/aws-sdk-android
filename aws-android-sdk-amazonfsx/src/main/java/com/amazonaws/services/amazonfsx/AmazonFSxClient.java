...
package com.amazonaws.services.amazonfsx;
...
import com.amazonaws.services.amazonfsx.model.transform.*;
...
public class AmazonFSxClient extends AmazonWebServiceClient implements AmazonFSx {
    ...
    private void init() {
        ...
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain(
                "/com/amazonaws/services/amazonfsx/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain(
                "/com/amazonaws/services/amazonfsx/request.handler2s"));
    }
