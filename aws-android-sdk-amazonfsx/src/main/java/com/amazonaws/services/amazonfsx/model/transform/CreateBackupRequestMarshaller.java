...
public class CreateBackupRequestMarshaller implements
    ...
    public Request<CreateBackupRequest> marshall(CreateBackupRequest createBackupRequest) {
        ...
        try {
            ...
            if (createBackupRequest.getFileSystemId() != null) {
                String fileSystemId = createBackupRequest.getFileSystemId();
                jsonWriter.name("FileSystemId");
                jsonWriter.value(fileSystemId);
            }
            if (createBackupRequest.getClientRequestToken() != null) {
                String clientRequestToken = createBackupRequest.getClientRequestToken();
                jsonWriter.name("ClientRequestToken");
                jsonWriter.value(clientRequestToken);
            }
            if (createBackupRequest.getTags() != null) {
                java.util.List<Tag> tags = createBackupRequest.getTags();
