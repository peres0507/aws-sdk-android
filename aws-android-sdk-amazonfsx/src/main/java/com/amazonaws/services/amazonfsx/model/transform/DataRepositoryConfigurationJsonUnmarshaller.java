...
/**
 * JSON unmarshaller for POJO DataRepositoryConfiguration
 */
class DataRepositoryConfigurationJsonUnmarshaller implements
        Unmarshaller<DataRepositoryConfiguration, JsonUnmarshallerContext> {
    ...
    public DataRepositoryConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("ImportPath")) {
                dataRepositoryConfiguration.setImportPath(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ExportPath")) {
                dataRepositoryConfiguration.setExportPath(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("ImportedFileChunkSize")) {
                dataRepositoryConfiguration.setImportedFileChunkSize(IntegerJsonUnmarshaller
                        .getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
