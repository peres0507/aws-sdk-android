...
/**
 * JSON unmarshaller for POJO UpdateFileSystemLustreConfiguration
 */
class UpdateFileSystemLustreConfigurationJsonUnmarshaller implements
        Unmarshaller<UpdateFileSystemLustreConfiguration, JsonUnmarshallerContext> {

    public UpdateFileSystemLustreConfiguration unmarshall(JsonUnmarshallerContext context)
            throws Exception {
