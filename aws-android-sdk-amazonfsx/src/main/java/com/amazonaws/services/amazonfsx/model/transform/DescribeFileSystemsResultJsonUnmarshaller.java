...
/**
 * JSON unmarshaller for response DescribeFileSystemsResult
 */
public class DescribeFileSystemsResultJsonUnmarshaller implements
    ...
    public DescribeFileSystemsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("FileSystems")) {
                describeFileSystemsResult.setFileSystems(new ListUnmarshaller<FileSystem>(
                        FileSystemJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                describeFileSystemsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
