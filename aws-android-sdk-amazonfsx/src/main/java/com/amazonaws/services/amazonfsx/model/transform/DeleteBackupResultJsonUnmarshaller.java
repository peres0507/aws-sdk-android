...
/**
 * JSON unmarshaller for response DeleteBackupResult
 */
public class DeleteBackupResultJsonUnmarshaller implements
        Unmarshaller<DeleteBackupResult, JsonUnmarshallerContext> {
    ...
    public DeleteBackupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("BackupId")) {
                deleteBackupResult.setBackupId(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else if (name.equals("Lifecycle")) {
                deleteBackupResult.setLifecycle(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
