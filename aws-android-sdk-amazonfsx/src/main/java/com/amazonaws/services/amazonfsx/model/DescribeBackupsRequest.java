 ...
 * Otherwise, it returns all backups owned by your AWS account in the AWS Region
...
public class DescribeBackupsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * @return <p>
     *         (Optional) IDs of the backups you want to retrieve (String). This
     *         overrides any filters. If any IDs are not found, BackupNotFound
     *         will be thrown.
     *         </p>
     */
     ...
     *            This overrides any filters. If any IDs are not found,
     ...
     *
     * @return <p>
     *         (Optional) Filters structure. Supported names are file-system-id
     *         and backup-type.
     *         </p>
     */
     ...
     *
     * @param filters <p>
     *            (Optional) Filters structure. Supported names are
     ...
     *         (integer). This parameter value must be greater than 0. The
