...
import com.amazonaws.services.amazonfsx.model.UnsupportedOperationException;
...
public class UnsupportedOperationExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(JsonErrorResponse error) throws Exception {
        return error.getErrorCode().equals("UnsupportedOperation");
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        e.setErrorCode("UnsupportedOperation");
