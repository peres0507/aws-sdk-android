...
/**
 * JSON unmarshaller for POJO Filter
 */
class FilterJsonUnmarshaller implements Unmarshaller<Filter, JsonUnmarshallerContext> {
    ...
    public Filter unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Name")) {
                ...
                filter.setValues(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else {
                reader.skipValue();
