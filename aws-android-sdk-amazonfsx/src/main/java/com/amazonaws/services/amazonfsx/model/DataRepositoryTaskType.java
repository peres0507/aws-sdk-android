...
public enum DataRepositoryTaskType {
    ...
    private static final Map<String, DataRepositoryTaskType> enumMap;
    static {
        enumMap = new HashMap<String, DataRepositoryTaskType>();
        enumMap.put("EXPORT_TO_REPOSITORY", EXPORT_TO_REPOSITORY);
    }
