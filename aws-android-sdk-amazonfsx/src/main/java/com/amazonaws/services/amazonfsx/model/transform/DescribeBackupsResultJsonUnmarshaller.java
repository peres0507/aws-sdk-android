...
/**
 * JSON unmarshaller for response DescribeBackupsResult
 */
public class DescribeBackupsResultJsonUnmarshaller implements
        Unmarshaller<DescribeBackupsResult, JsonUnmarshallerContext> {
    ...
    public DescribeBackupsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("Backups")) {
                describeBackupsResult.setBackups(new ListUnmarshaller<Backup>(
                        BackupJsonUnmarshaller.getInstance()
                        )
                                .unmarshall(context));
            } else if (name.equals("NextToken")) {
                describeBackupsResult.setNextToken(StringJsonUnmarshaller.getInstance()
                        .unmarshall(context));
            } else {
                reader.skipValue();
            }
